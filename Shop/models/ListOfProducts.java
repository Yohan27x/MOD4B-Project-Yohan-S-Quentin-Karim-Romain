    ...
    public void FillUserCart(){
        ...
        try (Connection connection = DriverManager.getConnection(url, username, passwordd)){
            ...
            while (resultSet2.next()) {
                AllAvailableProducts.add(new Product( resultSet2.getString("prodName"), Double.parseDouble(resultSet2.getString("Price")), resultSet2.getString("prodPath"), resultSet2.getString("Cartegory"), Integer.parseInt(resultSet2.getString("Quantity")), resultSet2.getString("prodDescription"), resultSet2.getInt("QuantityChosen")));
            }
